    ...
    @if($type == 'albums')
        <div class="container">
            <main id="main">
                ...
                <div class="row auto-fit-columns adonis-animate"
                                        ...
                                        <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                            <span class="pointer play-btn-dark round-btn adonis-album-button"
                                                  ...
                                                  data-album-id="{{$playlist->id}}"><i
                                                    class="fas fa-play fs-21 text-light play-index"></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
    ...
    @elseif($type == 'songs')
        <div class="container">
            <main id="main">
                ...
                <div class="row auto-fit-columns adonis-animate" data-animation-item=".col-auto"
    ...
    @elseif($type == 'artists')
        <div class="container">
            <main id="main">
                ...
                <div class="row auto-columns adonis-animate"
    ...
    @elseif($type == 'genres')
        <div class="container">
            <section>
                ...
                <div class="genres-list row adonis-animate" data-animation-item=".img-box-text-over">
