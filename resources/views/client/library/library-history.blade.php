...
@section('content')
    <section>
        ...
        <div class="d-flex">
            <div class="title-box">
                <h2 class="title h3-md">Các bài hát đã nghe</h2>
            </div>
        </div>


        @if(count($historySong) == 0)
            <div class="row">
                <div class="col-12">
                    <div class="no-content-block text-center p-5 rounded">
                        ...
                        <h3 class="m-3">Lịch sử bài hát của bạn đang trống</h3>
                        ...
                        <div class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
                            ...
                            <div class="hover-state d-flex justify-content-between align-items-center">
                                                 <span class="pointer play-btn-dark adonis-album-button"
                                                       data-album-id="{{$song->id}}" data-type="song">
