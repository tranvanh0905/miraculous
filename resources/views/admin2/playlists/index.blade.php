    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <a href="{{route('playlist.add')}}" class="btn btn-primary mr-auto"> <i class="nav-icon fas fa-plus"></i> Thêm danh sách phát</a>
                <form action="">
                        ...
                        <div class="col-sm-12">
                            <table id="song_table" class="table table-bordered table-striped dataTable hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Tên danh sách phát</th>
