    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <a href="{{route('albums.add')}}" class="btn btn-primary mr-auto"> <i class="nav-icon fas fa-plus"></i>
                    Thêm album</a>
                <form action="">
                        ...
                        <div class="col-sm-12">
                            <table id="song_table" class="table table-bordered table-striped dataTable hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Nghệ sĩ thể hiện</th>
            ...
            let table = $('#song_table').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        autoWidth: true,
                        render: function (data, type, row) {
                            let html = `<a href="albums/update/${data}" data-edit="' + data + '" class="mr-3"><i class="nav-icon fas
                            fa-edit"></i></a><a
